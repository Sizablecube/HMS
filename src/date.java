...
public class date extends javax.swing.JFrame {
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(in, javax.swing.GroupLayout.DEFAULT_SIZE, 201, Short.MAX_VALUE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
         ...
         Date cin = in.getDate();
         Date cout = out.getDate();
         
         long diffsec = Math.abs(cout.getTime() - cin.getTime());
         long diff = TimeUnit.DAYS.convert(diffsec, TimeUnit.MILLISECONDS);
         
         long x = 1000*diff;
         
         txt.setText(String.valueOf(diff));
         txt2.setText("R"+String.valueOf(x));
