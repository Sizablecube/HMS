    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        try{
            ...
            Statement stmt =(Statement)conn.createStatement();
                ...
                String insert;
                insert = "INSERT INTO `booking`(`First name`, `Second name`,`Username`, `Password`, `Cellphone`, `Email`, `address`, `ID number`, `Gender` ) VALUES ('"+fn.getText()+"','"+sn.getText()+"','"+txt.getText()+"','"+pwd.getText()+"','"+Cellphone.getText()+"','"+Email.getText()+"','"+Ad.getText()+"','"+ID.getText()+"','"+box.getSelectedItem()+"');";
